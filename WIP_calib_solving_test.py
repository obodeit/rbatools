...
permit_quadratic_model=True
regressed_specific_kapps=regression_on_specific_enzyme_efficiencies(Spec_Kapps=specific_kapps_from_calibration.copy(),min_kapp=3600,max_kapp=360000000,conditions=conditions,growth_rates=growth_rates,impose_on_isoenzymes=False,monotonous_quadratic=True,fill_in_missing_conditions=True,permit_quadratic_model=permit_quadratic_model)
regressed_default_kapps=regression_on_default_enzyme_efficiencies(default_kapps=default_kapps_from_calibration.copy(),min_kapp=3600,max_kapp=360000000,conditions=conditions,growth_rates=growth_rates,monotonous_quadratic=True,permit_quadratic_model=permit_quadratic_model)
regressed_process_efficiencies=regression_on_process_efficiencies(Process_efficiencies=process_efficiencies_from_calibration.copy(),min_efficiency=3600,max_efficiency=360000000,conditions=conditions,growth_rates=growth_rates,monotonous_quadratic=True,permit_quadratic_model=permit_quadratic_model)
